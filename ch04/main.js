...
document.addEventListener("DOMContentLoaded", function(){
    ...
    // NOTE [mnie]: fixed issue where it was possible to toggle while on big screens
    var bigScreen = window.matchMedia("(min-width: 40rem)").matches;
    if (!bigScreen) theBody.classList.toggle("OffCanvas-Active");
	}
